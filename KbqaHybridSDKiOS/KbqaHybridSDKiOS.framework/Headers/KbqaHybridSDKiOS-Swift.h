...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KbqaHybridSDKiOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class KbqaHomeHotSpotBean;

SWIFT_CLASS("_TtC16KbqaHybridSDKiOS21KbqaHomeHotSpotResult")
@interface KbqaHomeHotSpotResult : NSObject
@property (nonatomic, copy) NSArray<KbqaHomeHotSpotBean *> * _Nonnull data;
@end


SWIFT_CLASS("_TtCC16KbqaHybridSDKiOS21KbqaHomeHotSpotResult19KbqaHomeHotSpotBean")
...
SWIFT_CLASS("_TtC16KbqaHybridSDKiOS31KbqaHomeRecommendQuestionResult")
...
SWIFT_CLASS("_TtCC16KbqaHybridSDKiOS31KbqaHomeRecommendQuestionResult29KbqaHomeRecommendQuestionBean")
